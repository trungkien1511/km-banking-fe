      ...
      <div className="flex items-center space-x-2">
        <div className="relative flex items-center">
          ...
          <Check
            size={12}
            weight="bold"
            className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-primary-fg opacity-0 peer-checked:opacity-100 transition-opacity"
          />
        </div>
        {label && (
          <label
